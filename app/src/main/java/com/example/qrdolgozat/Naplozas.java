...
public class Naplozas {
    ...
    public static void kiiras(String szoveg) throws IOException
    {
        String allapot;
        File file;
        String szovegesAdat;
        ...
        szovegesAdat =String.valueOf(szoveg) + "," + formatedDate + "," + "\r\n";

        allapot = Environment.getExternalStorageState();
        if (allapot.equals(Environment.MEDIA_MOUNTED))
        {
            file = new File(Environment.getExternalStorageDirectory(), "dolgozat.csv");
            try
            {
